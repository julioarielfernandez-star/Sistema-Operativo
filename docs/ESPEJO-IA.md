...
Repo GitHub (fuente de verdad, se edita acá)
        │  rutina semanal — lunes 08:30 (ART)
        ▼
...
└── PAQUETE-SISTEMA - <fecha>.md         ← uno nuevo por semana (nunca se borra el anterior)
        │
        ▼
...
- Rutina programada: **"Espejo Paquete-Sistema-IA (semanal)"** (`trig_01E1JV7atChwLXgu4dvwgLeW`), lunes 08:30 hora argentina, ligada a la sesión remota de Claude con conector de Drive.
